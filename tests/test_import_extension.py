...
def test_import_extension(temp_module_directory, df_X,testpackage1, sym):
    ...
    with save_current_installed_extensions():
        ...
        pdext.import_extension(testpackage1+sym.__import_file_sep__+'calculate_circumference_from_radius')
        pdext.import_extension(testpackage1+sym.__import_file_sep__+'test.calculate_circumference_from_diameter')
...
def test_extension_dependency_not_installed(temp_module_directory, df_X, 
    ...
    with save_current_installed_extensions():
        ...
        pdext.import_extension(testpackage1+sym.__import_file_sep__+'function_uses_external_package_not_installed')
